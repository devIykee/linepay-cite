...
export default function SimulateBanner() {
  ...
  return (
    <div className="mb-4 rounded-lg border border-yellow-400 bg-yellow-50 px-4 py-3 font-label-lg text-label-lg text-yellow-900">
      ⚠️ Simulate mode active — no real payments are being processed.
    </div>
  );
}
